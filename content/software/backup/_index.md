...
{{< card link="restic" title="restic" icon="archive" subtitle="Deduplicating encrypted snapshots from one binary." >}}
{{< card link="borgbackup" title="BorgBackup" icon="database" subtitle="Deduplicating archives, compressed and authenticated." >}}
{{< card link="kopia" title="Kopia" icon="server" subtitle="Snapshots with a desktop app and a policy engine." >}}
{{< card link="rclone" title="rclone" icon="cloud" subtitle="Sync and encrypt to sixty-odd cloud providers." >}}
{{< card link="clonezilla" title="Clonezilla" icon="desktop-computer" subtitle="Bootable disk and partition imaging for the rest of the rack." >}}
{{< /cards >}}
