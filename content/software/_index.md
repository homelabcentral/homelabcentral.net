...
{{< lead >}}
macOS software worth installing — 135 tools across 17 categories.
{{< /lead >}}
...
{{< cards cols="3" >}}
{{< card link="development" title="Development & Coding" icon="code" subtitle="Editors, AI coding agents, and the clients that sit open beside them." tag="10" tagColor="gray" >}}
...
{{< card link="media" title="Media & Video" icon="film" subtitle="Editing, screen recording, transcoding, downloading and playback." tag="14" tagColor="gray" >}}
...
{{< card link="networking" title="Networking & Remote Access" icon="status-online" subtitle="VPNs, mesh networking, remote desktops, file transfer and cable diagnostics." tag="7" tagColor="gray" >}}
{{< card link="virtualization" title="Virtualization & Emulation" icon="server" subtitle="Virtual machines, installer media, and emulating other architectures." tag="3" tagColor="gray" >}}
...
{{< card link="maintenance" title="Disk, Cleanup & Maintenance" icon="trash" subtitle="Finding what filled the disk, uninstalling properly, and making installer media." tag="10" tagColor="gray" >}}
...
{{< card link="security" title="Security & Privacy" icon="shield-check" subtitle="Password management and persistence auditing." tag="2" tagColor="gray" >}}
...
{{< card link="fonts" title="Fonts" icon="translate" subtitle="Monospaced coding fonts, Nerd Font patched." tag="5" tagColor="gray" >}}
{{< /cards >}}
