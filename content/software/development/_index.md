...
{{< lead >}}Where the code actually gets written, and the handful of clients kept open next to the editor.{{< /lead >}}

{{< cards cols="3" >}}
{{< card link="visual-studio-code" title="Visual Studio Code" icon="code" subtitle="Primary code editor, extension-driven." >}}
{{< card link="xcode" title="Xcode" icon="device-mobile" subtitle="Apple's IDE, SDKs, simulators and command-line tools." >}}
{{< card link="claude-desktop" title="Claude" icon="claude" subtitle="Anthropic's desktop client for Claude." >}}
