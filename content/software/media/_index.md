...
{{< lead >}}A full video chain: capture, record, edit, grade, transcode, serve and play — plus the command-line tools the GUIs are built on.{{< /lead >}}
...
{{< card link="cleanshot-x" title="CleanShot X" icon="scissors" subtitle="Screenshots, annotation and recording in one overlay." >}}
{{< card link="screen-studio" title="Screen Studio" icon="sparkles" subtitle="Recorder that adds zooms and cursor easing automatically." >}}
{{< card link="shottr" title="Shottr" icon="camera" subtitle="Fast native screenshots, with measuring and OCR." >}}
{{< card link="kap" title="Kap" icon="video-camera" subtitle="Open-source recorder for short GIF and MP4 clips." >}}
{{< card link="cap" title="Cap" icon="video-camera" subtitle="Open-source recorder with auto-zoom and optional sharing." >}}
