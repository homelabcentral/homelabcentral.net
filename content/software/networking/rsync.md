...
| [Carbon Copy Cloner](/software/backup/carbon-copy-cloner/) or [Time Machine](/software/backup/time-machine/) | Paid / Built in | For Mac backups specifically, with snapshots           |
{{< /borderless-table >}}
